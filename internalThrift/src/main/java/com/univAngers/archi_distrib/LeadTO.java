...
public class LeadTO implements org.apache.thrift.TBase<LeadTO, LeadTO._Fields>, java.io.Serializable, Cloneable, Comparable<LeadTO> {
  ...
  public LeadTO setCreationDate(long creationDate) {
    this.creationDate = creationDate;
    setCreationDateIsSet(true);
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'creationDate' because it's a primitive and you chose the non-beans generator.
    if (company == null) {
  ...
  private static class LeadTOStandardScheme extends org.apache.thrift.scheme.StandardScheme<LeadTO> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, LeadTO struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetCreationDate()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'creationDate' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
